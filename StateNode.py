    ...
    def get_reward(self, unsafe_counts, total_power):
        ...
        if self.step == self.max_step:
            ...
            if self.speed_punish:
                ...
                self.current_reward = -3 * (total_power - self.line.ac_power) - 2.5 * self.next_state[1] + 1 * t_punish + e_reward - 10 * self.comfort_punish
            ...
            if self.speed_punish:
                ...
                self.current_reward = -10 * self.t_power - 10 * self.re_power - 3.5 * abs(
